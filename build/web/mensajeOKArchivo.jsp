<%-- 
    Document   : mensajeOKArchivo
    Created on : 30/06/2016, 07:31:13 AM
    Author     : OrlandorMx
--%>
...
<html>
    <head>
        ...
        -->
        <link rel="stylesheet" href="css_propios/error.css">
    ...
    <body class="escritorio" background="img/escritorio.jpg">
        <% Object tituloPDF = (String) session.getAttribute("tituloPDF");%>
        ...
        <section class="container">
            ...
            <section class="row cuerpo_2">
                ...
                <section class="col-lg-9 bloque_izquierdo">
                    ...
                    <h1>Archivo: <%= tituloPDF%>.pdf cargado exitosamente!</h1>
                    <h1>Redireccionando a inicio...</h1>
                    <META HTTP-EQUIV="Refresh" CONTENT="5; URL=plantillas/inicio.jsp">
                    </div>
                </section>
