<%-- 
    Document   : inicio
    Created on : 28/06/2016, 09:02:26 AM
    Author     : OrlandorMx
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css_propios/general.css">
        <link rel="stylesheet" type="text/css" href="../css_propios/menu_navegacion.css">
        <link rel="stylesheet" type="text/css" href="../css_propios/inicio.css">
    ...
    <body class="escritorio" background="../img/background.jpg">
        <% Object a = (String) session.getAttribute("nombreU");%>
            ...
            <section class="row cuerpo_2">
                ...
                <section class="col-lg-9 bloque_lateral_2">
                    <section class="col-lg-12 col-md-12  ">
                        <div class="col-lg-12 ">
                            <ul class="breadcrumb bienvenido">
                                
                                <a >BIENVENIDO <%=a%></a>
                            </ul>


                            <h4 class="subtitulo_seccion">Recursos Personales</h4>
                            <section class="col-lg-12 col-md-12 personal">
                                <section class="col-lg-4 col-md-4 bloque_anuncio_personal">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso Personal 1</section>
                                ...
                                <section class="col-lg-4 col-md-4 bloque_anuncio_personal">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso Personal 2</section>
                                ...
                                <section class="col-lg-4 col-md-4 bloque_anuncio_personal">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso Personal 3</section>
                            ...
                            <h4 class="subtitulo_seccion">Recursos Generales</h4>
                            <section class="col-lg-12 col-md-12 general">
                                <section class="col-lg-4 col-md-4 bloque_anuncio_general">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso General 1</section>
                                ...
                                <section class="col-lg-4 col-md-4 bloque_anuncio_general">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso General 2</section>
                                ...
                                <section class="col-lg-4 col-md-4 bloque_anuncio_general">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso General 3</section>
