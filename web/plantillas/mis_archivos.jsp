<%-- 
    Document   : mis_archivos
    Created on : 28/06/2016, 09:05:21 AM
    Author     : OrlandorMx
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css_propios/mis_archivos.css">
    ...
    <body class="escritorio" background="../img/background.jpg">
        ...
        <section class="container">
            ...
            <section class="row cuerpo_2">
                ...
                <section class="col-lg-12 bloque_lateral_2">
                    <section class="col-lg-12 col-md-12  ">
                        <div class="col-lg-12 ">
                            ...
                            <section class="col-lg-12 col-md-12 personal">
                                <section class="col-lg-3 col-md-3 bloque_anuncio_personal">
                            ...
                            <section class="col-lg-12 col-md-12 personal">
                                ...
                                <section class="col-lg-3 col-md-3 bloque_anuncio_personal">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso 7</section>
                                ...
                                <section class="col-lg-3 col-md-3 bloque_anuncio_personal">
                                    <section class="col-lg-12 col-md-12 nombre_aviso">Recurso 8</section>
